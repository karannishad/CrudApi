...
public class Test {
    ...
    public static int[] circurlar(int n[], int k, int q[]) {
        int x[] = new int[q.length], inc = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(nonDivisibleSubset(3, new ArrayList<>(Arrays.asList(19, 10, 12, 24, 25, 22))));
    }
}